...
WHERE per.IdPersona='".$IdMedico."' AND noti.FechaNotificacion BETWEEN '".$DataIni." 00:00:00' AND '".$DataFin." 23:59:59' GROUP BY pac.IdPaciente , pac.Rut,pac.Correo,pac.Clave,  pac.PrimerNombre, pac.SegundoNombre, pac.PrimerApellido,pac.SegundoApellido,pac.FechaN,pac.Telefono,pac.Direccion" );
$resultado=array();
