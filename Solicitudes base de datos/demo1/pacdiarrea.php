...
WHERE per.IdPersona='".$IdMedico."' AND bita.FechaHora BETWEEN '".$DataIni." 00:00:00' AND '".$DataIni." 23:59:59' AND bita.Diarrea>'2' GROUP BY pac.IdPaciente , pac.Rut ORDER BY `MaxDiarrea` DESC" );
$resultado=array();
