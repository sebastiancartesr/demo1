...
WHERE per.IdPersona='".$IdMedico."' AND pac.IdPaciente NOT IN (SELECT bitacora.IdPaciente FROM bitacora WHERE bitacora.FechaHora BETWEEN '".$DataIni." 00:00:00' AND '".$DataIni." 23:59:59')" );
$resultado=array();
