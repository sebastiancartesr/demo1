...
class ElegirBitacora extends StatefulWidget {
  ElegirBitacora({Key key}) : super(key: key);

  @override
  _ElegirBitacoraState createState() => _ElegirBitacoraState();
}

class _ElegirBitacoraState extends State<ElegirBitacora> {
