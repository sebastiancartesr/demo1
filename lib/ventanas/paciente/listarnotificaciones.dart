...
class ListarNotificaciones extends StatefulWidget {
  ListarNotificaciones({Key key}) : super(key: key);

  @override
  _ListarNotificacionesState createState() => _ListarNotificacionesState();
}

class _ListarNotificacionesState extends State<ListarNotificaciones> {
     final Usuario _usuario = new Usuario();
     
    Future<List> getData() async {
    final response = await http.post("http://192.168.1.108/demo1/getnotificaciones.php", body:{
